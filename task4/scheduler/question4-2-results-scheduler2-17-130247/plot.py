...
print(datetime.datetime.fromtimestamp(timestamp_start/1000.0)-datetime.timedelta(hours=2))
print(datetime.timedelta(seconds=2 * interval_duration))
print(scheduler_start_time)
...
axB.plot(core_times, core_values, color='orange', label='Memcached CPU Cores')
