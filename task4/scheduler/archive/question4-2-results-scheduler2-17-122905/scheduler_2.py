...
class Scheduler(object):
    ...
    def run(self):
        ...
        count_cpu_between_thresholds = 0
        keep_on_high = 3 # avoid switch too quickly
        ...
        while True:
            ...
            if cpu_usage_memcached > THRESHOLD_HIGH or count_cpu_between_thresholds > 5:
                ...
                count_cpu_between_thresholds = count_cpu_between_thresholds + 1
