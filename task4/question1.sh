...
for i in 1 2 3; do
    ...
    tmux send-keys -t measure "taskset -a -c $c ./mcperf -s $INTERNAL_MEMCACHED_IP -a $INTERNAL_AGENT_IP --noload -T 16 -C 4 -D 4 -Q 1000 -c 4 -t 5 --scan 5000:125000:5000" C-m
